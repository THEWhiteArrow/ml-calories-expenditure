...
class EnsembleModel2(BaseEstimator):
    ...
    def clean_copy(self) -> "EnsembleModel2":
        ...
        return EnsembleModel2(
            ...
            combination_features=[features for features in self.combination_features],
            combination_names=self.combination_names,
            combination_scoring=self.combination_scoring,
            combination_metadatas=self.combination_metadatas,
            scoring_direction=self.scoring_direction,
            task=self.task,
            metamodel=(
